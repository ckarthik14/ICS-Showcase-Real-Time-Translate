...
def on_message(ws, message):
    ...
    stream_name = 'ICS_Showcase_from_agent_audio'
    partition_key = 'audio'
...
def start_websocket():
    ws_url = 'wss://encgiyvrte.execute-api.us-east-1.amazonaws.com/dev/?communicator=AGENT_SERVER&connectionType=RAW_AUDIO'
